...
INSERT INTO t_phone(number, hash)
...
INSERT INTO t_party_contact_mechanism(party_fk, phone_fk, type_fk, purpose_fk, no_solicitation)
  SELECT DISTINCT pattr_party_fk, id, 400, 401, 0
  FROM is5.pattr JOIN t_phone ON  MD5(LOWER(CONCAT("-", pattr.pattr_value, "-")))=hash
